...
public class V2rayController {
    ...
    /**
     * Overloaded init for non-AppCompatActivity hosts (e.g. FlutterActivity).
     * VPN permission must be handled externally when using this variant.
     */
    public static void init(final Activity activity, final int app_icon, final String app_name) {
        Utilities.copyAssets(activity);
        currentConfig.applicationIcon = app_icon;
        currentConfig.applicationName = app_name;
        registerReceivers(activity);
