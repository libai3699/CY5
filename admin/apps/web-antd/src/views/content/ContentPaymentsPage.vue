...
<template>
  <div class="p-4">
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑支付配置' : '新增支付配置'" width="700px">
      <el-form :model="form" label-width="120px">
        ...
        <el-form-item label="显示名称" required>
          <el-input v-model="form.label" placeholder="如：USDT (BEP20)" />
        </el-form-item>
        
        <el-form-item label="收款地址/账号">
          <el-input 
            v-model="form.address" 
            type="textarea"
            :rows="2"
            placeholder="USDT地址、微信号、支付宝账号等" 
          />
          <div class="text-xs text-gray-500 mt-1">
            提示：USDT、微信、支付宝都需要填写收款地址/账号，并上传对应收款二维码
          </div>
        </el-form-item>
