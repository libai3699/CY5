...
type Device struct {
	...
	DeviceID  string `gorm:"size:128;uniqueIndex;not null" json:"device_id"` // 内部唯一标识（随机 hex）
	DisplayID string `gorm:"size:16;uniqueIndex;not null" json:"display_id"` // 用户可见的 7 位数字 ID
