...
export async function decryptSiteConfig(
  encrypted: string,
...
export function normalizeSiteConfig(payload: any): DownloadConfig {
  ...
  return {
    ...
    vpn_exe: pick(
      "vpn_exe",
      "download_vpn_exe",
      "download_vpn_windows_url",
      "vpn_windows_download_url",
      "download_vpn_apk",
      "vpn_apk",
    ),
    acc_exe: pick(
      "acc_exe",
      "download_acc_exe",
      "download_acc_windows_url",
      "acc_windows_download_url",
      "download_acc_apk",
      "acc_apk",
    ),
    ...
    telegram_subscription_url: pick(
